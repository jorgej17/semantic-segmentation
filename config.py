...
__C.ASSETS_PATH = '/home/jovyan/pretrainedweights'
...
__C.DATASET.KARTAI_DIR = \
  os.path.join(__C.ASSETS_PATH, '/home/jovyan/semantic-segmentation/data256')
__C.DATASET.CITYSCAPES_DIR = \
  os.path.join(__C.ASSETS_PATH, '/home/jovyan/semantic-segmentation/leftImg8bit')
